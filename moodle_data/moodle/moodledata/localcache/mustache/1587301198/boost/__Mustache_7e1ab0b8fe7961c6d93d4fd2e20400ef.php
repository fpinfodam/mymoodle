...
class __Mustache_7e1ab0b8fe7961c6d93d4fd2e20400ef extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE8f2817a6e792295486064120f806d10($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        // 'caninstall' section
        $value = $context->find('caninstall');
        $buffer .= $this->section3ac9172b022b4a8d9041a7e0dd84f6e1($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionE8f2817a6e792295486064120f806d10(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3ac9172b022b4a8d9041a7e0dd84f6e1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
